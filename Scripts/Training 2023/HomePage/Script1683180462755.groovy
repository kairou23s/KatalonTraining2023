...
WebUI.callTestCase(findTestCase('Training 2023/LoginTest'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/span_PaulSriharidfd Collings'))
